local Library = loadstring(game:HttpGet("https://github.com/Sphereuz/UiLibsCSGO/raw/refs/heads/main/LunarVIP/Lib.lua"))()
...
local legit = Window:Page({Name = "Legit"}) do 
    ...
    local Test = legit:Section({Name = "Section Test", Size = 330}) do 
        ...
        Test:Dropdown({Name = "Method", Flag = "Select option and noti test", Options = {"test", "a", "b"}, Default = "test", 
